 ...
 *
 */
public class A04DepositAccountMain extends EntScreenMain {
	...
	public A04DepositAccountMain(JFrame frame, EntBean entBean, String userId){
		this.frame = frame;
	...
	public void initScreen() {
		...
		this.btnInsert = new EntJButton("입금");
	...
	public void insert(){
		...
		int nResult = showConfirmDialog("입금 처리하시겠습니까?");
		if(nResult != 0) return;
		...
		A04DepositAccountMainInsert01DTO inputDTO = new A04DepositAccountMainInsert01DTO();
		...
		inputDTO.setLinkType(strLinkType);
		
		businessDTO.addTransaction("A04201", inputDTO);
	...
	public void changeCbLinkType(){
		...
		if(strCode.equals("0")){
			...
			this.tfCashAmount.setValue("0");
			this.tfCashAmount.setEnabled(false);
		}
	}
