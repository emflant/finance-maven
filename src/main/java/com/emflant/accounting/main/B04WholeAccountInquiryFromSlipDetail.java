...
import com.emflant.accounting.main.B02SlipDetailInquiryByAccountTypeMain.CbAccountChangeListener;
...
public class B04WholeAccountInquiryFromSlipDetail extends EntScreenMain {
	...
	public B04WholeAccountInquiryFromSlipDetail(JFrame frame, EntBean entBean, String userId){
		this.frame = frame;
...
//		transactionCommitOneByOne(businessDTO);		
	...
	public void search() {
		...
		EntBusiness businessDTO = new EntBusiness();
		businessDTO.addTransaction("S04101");
