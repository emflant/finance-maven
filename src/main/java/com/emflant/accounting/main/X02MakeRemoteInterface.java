...
public class X02MakeRemoteInterface extends EntScreenMain {
	...
	public X02MakeRemoteInterface(JFrame frame, EntBean entBean, String userId){
		this.frame = frame;
	...
	public void insert(String tableName){
		...
		businessDTO.addTransaction("X02103", tableName);
	...
	class X02ChangeBeanTypeComboBoxListener implements ActionListener {
	...
	public void search() {
		...
		EntBusiness businessDTO = new EntBusiness();
		businessDTO.addTransaction("X02102", this.cbBeanType.entGetCodeOfSelectedItem());
		transactionCommitOneByOne(businessDTO);
